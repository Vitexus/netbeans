...
class ConstructorPropertyPromotionWrong3 {
    ...
    public function __construct(protected ?int $mandatory1, $optional = "default value", private string $mandatory2) {
    }
...
class ConstructorPropertyPromotionWrong4 {
    ...
    public function __construct(private ?int $mandatory1, private $optional = "default value", public string $mandatory2) {
    }
