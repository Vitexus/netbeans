...
/**
 * Stores and loads web browser settings. For visual representation see
 * core.ui/src/org/netbeans/core/ui/options/general.
 */
public class IDESettings {
    ...
    /**
     * Number of recent porojects in list *
     */
    public static final String PROP_RECENT_PROJECTS_COUNT = "RecentProjectsCount"; // NOI18N
    ...
    /**
     * Getter for recent project count
     * 
     * @return 
     */
    public static Integer getRecentProjectsCount() {
        return getPreferences().get(PROP_RECENT_PROJECTS_COUNT, null) == null ? 10 : Integer.parseInt(getPreferences().get(PROP_RECENT_PROJECTS_COUNT, null));
    }

    /**
     * Setter for recent project count
     * @param recentProjectsCount 
     */
    public static void setRecentProjectsCount(int recentProjectsCount) {
        try {
            getPreferences().put(PROP_RECENT_PROJECTS_COUNT, String.valueOf(recentProjectsCount));
        } catch (Exception ex) {
     ...
     *
     * First time when this function is called Lookup is used to find prefered
     * browser factory in a browser registry.
     *
     * @return prefered browser, may return null if it is not possible to get
     * the browser
     */
     ...
     * browser factory in a browser registry.
     *
     * @return prefered external browser, may return null if it is not possible
     * to get the browser or no external browser is available.
     */
     ...
     *
     * Actually Node.Handle of node that represent browser in lookup folder is
     * stored.
     *
